...
try:
    ...
    ignore_meta_list = ['database', 'dicom', 'fem-fenics', 'geometry', 'image', 'level-set', 'ltfat', 'ocs', 'quaternion','secs2d', 'sparsersb', 'tisean', 'vibes', 'video', 'image-acquisition', 'strings', 'fits']
